...
class TestPlace(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """set up for testing the class place"""
        cls.place = Place()
    ...
    def test_pep8_Place(self):
        """checking place for pep8 style"""
        style = pep8.StyleGuide(quiet=True)
        p = style.check_files(['models/place.py'])
        self.assertEqual(p.total_errors, 0, "fix pep8")

    def test_checking_for_docstring_Place(self):
        """checking class for docstrings"""
        self.assertIsNotNone(Place.__doc__)

    def test_attributes_Place(self):
        """chekcing if class place has attributes"""
    ...
    def test_is_subclass_Place(self):
        """checking if Place is subclass of Basemodel"""
        self.assertTrue(issubclass(self.place.__class__, BaseModel), True)

    def test_attribute_types_Place(self):
        """checking attribute type for Place"""
